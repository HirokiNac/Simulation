    ...
    public partial class Form1 : Form
    {
        ...
        private void button_Calc_Click(object sender, EventArgs e)
        {
            ...
            for (int i = 0; i < spot.GetLength(0); i++)
            {
                ...
                {
                    spot[i, j] = -spot[i, j] > 0 ? -spot[i, j] : 0;
                }
            }
            ...
            {
                Deconvolution2(spot, fig_pre, damp, out fig_aft, out time, out RMS);
                ...
                {
                    Array.Copy(fig_aft, 0, fig_pre, 0, fig_aft.Length);
                    RMSpre = RMS;
                }

                System.Diagnostics.Debug.Print(RMS.ToString() + "," + damp.ToString());
        ...
        {     
            ...
            for (int iy_StayTime = 0; iy_StayTime < ny_StayTime; iy_StayTime++)
            {
                for (int ix_StayTime = 0; ix_StayTime < nx_StayTime; ix_StayTime++)
                {
                    ...
                    tmpStayTime /= ((nx_Spot * ny_Spot) * _damp);
