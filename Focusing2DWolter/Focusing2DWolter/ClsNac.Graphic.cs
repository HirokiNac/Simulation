...
using System.Windows.Forms;
    ...
    namespace ClsNac.Graphic
    {
        ...
        public Plot2dPlane(PictureBox pictureGraphArea,int _intPictureColumn,int _intPictureRow)
        {
            try
            {
                //ピクチャサイズの取得
                intPictureColumn = _intPictureColumn;
                intPictureRow = _intPictureRow;
                //intPictureColumn = pictureGraphArea.Width;
                //intPictureRow = pictureGraphArea.Height;
        ...
        public bool Draw(double[,] data)
            {
                ...
                //データ最大値最小値の取得
                bool test = this.GetMaxMinZero(data);
        ...
        //データの最大値最小値の取得
        public bool GetMaxMinZero(double[,] data)
        {
            try
            {
                int column, row;
