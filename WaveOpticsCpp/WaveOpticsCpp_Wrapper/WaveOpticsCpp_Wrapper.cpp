	...
	int _n2, array<double>^ _x2, array<double>^ _y2, array<double>^ _z2, array<double>^ _u2re, array<double>^ _u2im)
{
	...
	pin_ptr<double> ptr_u2re = &_u2re[0];
	pin_ptr<double> ptr_u2im = &_u2im[0];
	pin_ptr<double> ptr_ds1 = &_ds1[0];

	WaveOpticsCpp::Prop2D(_lambda, _dir,
		_n1, ptr_x1, ptr_y1, ptr_z1, ptr_u1re, ptr_u1im, ptr_ds1,
		_n2, ptr_x2, ptr_y2, ptr_z2, ptr_u2re, ptr_u2im);
	...
	int _n2, array<double, 2>^ _x2, array<double, 2>^ _y2, array<double, 2>^ _z2, array<double, 2>^ _u2re, array<double, 2>^ _u2im)
{
	...
	pin_ptr<double> ptr_u2re = &_u2re[0, 0];
	pin_ptr<double> ptr_u2im = &_u2im[0, 0];
	...
	int _n2, array<double, 2>^ _x2, array<double, 2>^ _y2, array<double, 2>^ _z2, array<double, 2>^ _u2re, array<double, 2>^ _u2im)
{
	...
	pin_ptr<double> ptr_u2re = &_u2re[0, 0];
	pin_ptr<double> ptr_u2im = &_u2im[0, 0];
	pin_ptr<double>ptr_ds1 = &_ds1[0, 0];
