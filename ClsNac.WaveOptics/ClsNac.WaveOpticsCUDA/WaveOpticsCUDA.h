...
extern "C" {
	...
	__declspec(dllexport) void PropBw1d(double _lambda,
		int _n1, double* _x1, double* _y1, double* _u1re, double* _u1im,
		int _n2, double* _x2, double* _y2, double* &_u2re, double* &_u2im);
	...
	__declspec(dllexport) void PropFw2d(double _lambda,
	...
	__declspec(dllexport) void PropFw2d2(double _lambda,
	...
	__declspec(dllexport) void PropFw2d_f(float _lambda,
