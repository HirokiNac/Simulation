...
int _n2, double* _x2, double* _y2, double* _z2, double* &_u2re, double* &_u2im)
{
	...
	PropFw2D << <_n2 / 512, 512 >> >(_k, _n1, dx1, dy1, dz1, du1re, du1im, _n2, dx2, dy2, dz2, du2re, du2im);
...
int _n2, float* _x2, float* _y2, float* _z2, float* &_u2re, float* &_u2im)
{
	...
	PropFw2D_f << <_n2 / 256, 256>> >(_k, _n1, dx1, dy1, dz1, du1re, du1im, _n2, dx2, dy2, dz2, du2re, du2im);
