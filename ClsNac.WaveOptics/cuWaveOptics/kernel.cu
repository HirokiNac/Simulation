...
__global__ void Execute1D(const double _k, const int _dir,
	const int _n1, const double* _x1, const double* _y1, const double* _u1r, const double* _u1i,
	const int _n2, const double* _x2, const double* _y2, double* _u2r, double* _u2i)
{
...
__global__ void Execute1D_f(const float _k, const int _dir,
	const int _n1, const float* _x1, const float* _y1, const float* _u1r, const float* _u1i,
	const int _n2, const float* _x2, const float* _y2, float* _u2r, float* _u2i)
{
	const unsigned int col = blockIdx.x*blockDim.x + threadIdx.x;
...
__global__ void Execute2D(const double _k,const int _dir,
...
__global__ void PropFw2D2(const double _k,const int _dir,
...
extern "C" void
Propagate1DCuda(double _k,int _dir,
	...
	int _n2, double* _x2, double* _y2, double* &_u2re, double* &_u2im)
{
	...
	Execute1D << <numBlock, threadsPerBlock >> > (_k, _dir, _n1, dx1, dy1, du1re, du1im, _n2, dx2, dy2, du2re, du2im);
...
extern "C" void
Propagate1DCuda_f(float _k,int _dir,
	...
	int _n2, float* _x2, float* _y2, float* &_u2re, float* &_u2im)
{
	...
	Execute1D_f << <numBlock, threadsPerBlock >> > (_k, _dir, _n1, dx1, dy1, du1re, du1im, _n2, dx2, dy2, du2re, du2im);
